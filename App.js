...
export default function StickOfMeritocracy() {
  ...
  return (
    <div className="p-4">
      <img src={logo} alt="Mission Diverse" className="mb-4 w-32 mx-auto" />
      ...
      >
        ...
        <Card className="mb-4">
          <CardContent>
            <h2 className="text-xl mb-2">Drawing Board</h2>
            <div className={`canvas-container ${effect}`}>
              <CanvasDraw
                ref={setCanvasRef}
                canvasWidth={300}
                canvasHeight={300}
            ...
            <Button onClick={clearCanvas} className="mt-4 w-full">
              Clear Drawing
            </Button>
            <Button onClick={saveDrawing} className="mt-4 w-full">
              Save Drawing
            </Button>
            <Button onClick={showGallery} className="mt-4 w-full">
              Show Gallery
            </Button>
          </CardContent>
        </Card>
